...
/*
 * Auth-gate tests for ShiftManagementController.
 * Verifies the class-level [Authorize] gate on ShiftManagementController via /api/volunteering/swaps.
 */
...
public class ShiftManagementControllerAuthTests : IntegrationTestBase
{
    public ShiftManagementControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/volunteering/swaps";
