...
/*
 * Auth-gate tests for PerformanceMonitorController.
 * Verifies the [Authorize(Policy = AdminOnly)] gate on /api/admin/monitor/health.
 */
...
public class PerformanceMonitorControllerAuthTests : IntegrationTestBase
{
    public PerformanceMonitorControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/admin/monitor/health";
