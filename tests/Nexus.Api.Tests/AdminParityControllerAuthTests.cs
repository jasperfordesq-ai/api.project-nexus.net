...
/*
 * Auth-gate tests for AdminParityController.
 * Verifies the [Authorize(Policy = AdminOnly)] gate on AdminParityController catch-all.
 */
...
public class AdminParityControllerAuthTests : IntegrationTestBase
{
    public AdminParityControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/admin/parity-unmatched-stub-xyz";
