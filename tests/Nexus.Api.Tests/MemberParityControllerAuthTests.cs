...
/*
 * Auth-gate tests for MemberParityController.
 * Verifies the class-level [Authorize] gate on /api/me/dashboard.
 */
...
public class MemberParityControllerAuthTests : IntegrationTestBase
{
    public MemberParityControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/me/dashboard";
