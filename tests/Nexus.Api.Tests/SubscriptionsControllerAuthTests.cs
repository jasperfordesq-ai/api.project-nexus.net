...
/*
 * Auth-gate tests for SubscriptionsController.
 * Verifies the per-action [Authorize] gate on /api/subscriptions/my.
 */
...
public class SubscriptionsControllerAuthTests : IntegrationTestBase
{
    public SubscriptionsControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/subscriptions/my";
