...
/*
 * Auth-gate tests for AdminGdprController.
 * Verifies the [Authorize(Policy = AdminOnly)] gate on /api/admin/privacy/deletions.
 */
...
public class AdminGdprControllerAuthTests : IntegrationTestBase
{
    public AdminGdprControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/admin/privacy/deletions";
