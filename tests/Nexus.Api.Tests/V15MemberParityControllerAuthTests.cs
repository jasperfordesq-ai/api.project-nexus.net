...
/*
 * Auth-gate tests for V15MemberParityController.
 * Verifies the class-level [Authorize] gate on V15MemberParityController via /api/v2/events.
 */
...
public class V15MemberParityControllerAuthTests : IntegrationTestBase
{
    public V15MemberParityControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/v2/events";
