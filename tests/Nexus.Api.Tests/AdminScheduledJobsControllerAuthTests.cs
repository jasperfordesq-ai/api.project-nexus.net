...
/*
 * Auth-gate tests for AdminScheduledJobsController (V2 admin cron view).
...
public class AdminScheduledJobsControllerAuthTests : IntegrationTestBase
{
    public AdminScheduledJobsControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }
    ...
    public async Task AdminScheduledJobs_AuthGate(string role, int expectedStatus)
    {
        if (role == "anonymous")
        {
            ClearAuthToken();
