...
/*
 * Auth-gate tests for MiscParityController.
 * Verifies the per-action [Authorize] gate on /api/achievements (MiscParityController).
 */
...
public class MiscParityControllerAuthTests : IntegrationTestBase
{
    public MiscParityControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/achievements";
