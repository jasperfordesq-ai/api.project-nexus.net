...
/*
 * Auth-gate tests for KnowledgeBaseAdminController.
 * Verifies the [Authorize(Policy = AdminOnly)] gate on /api/admin/knowledge/articles.
 */
...
public class KnowledgeBaseAdminControllerAuthTests : IntegrationTestBase
{
    public KnowledgeBaseAdminControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/admin/knowledge/articles/999999";
