...
/*
 * Auth-gate tests for AdminLegalDocumentsController.
 * Verifies the [Authorize(Policy = AdminOnly)] gate on /api/admin/legal/documents.
 */
...
public class AdminLegalDocumentsControllerAuthTests : IntegrationTestBase
{
    public AdminLegalDocumentsControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/admin/legal/documents";
