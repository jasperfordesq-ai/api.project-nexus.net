...
/*
 * Auth-gate tests for VereineParityController.
 * Verifies the class-level [Authorize] gate on /api/vereine.
 */
...
public class VereineParityControllerAuthTests : IntegrationTestBase
{
    public VereineParityControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/vereine/1/cross-invitations";
