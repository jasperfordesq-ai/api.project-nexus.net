...
/*
 * Auth-gate tests for DonationsController.
 * Verifies the per-action [Authorize] gate on /api/donations/me.
 */
...
public class DonationsControllerAuthTests : IntegrationTestBase
{
    public DonationsControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/donations/me";
