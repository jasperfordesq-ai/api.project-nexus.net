...
/*
 * Auth-gate tests for StoriesController.
 * Verifies the class-level [Authorize] gate on /api/stories.
 */
...
public class StoriesControllerAuthTests : IntegrationTestBase
{
    public StoriesControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/stories";
