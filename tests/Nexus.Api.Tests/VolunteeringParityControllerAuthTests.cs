...
/*
 * Auth-gate tests for VolunteeringParityController.
 * Verifies the class-level [Authorize] gate on /api/volunteering/shifts.
 */
...
public class VolunteeringParityControllerAuthTests : IntegrationTestBase
{
    public VolunteeringParityControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/volunteering/shifts";
