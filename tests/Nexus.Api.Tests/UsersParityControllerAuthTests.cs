...
/*
 * Auth-gate tests for UsersParityController.
 * Verifies the class-level [Authorize] gate on /api/users/search.
 */
...
public class UsersParityControllerAuthTests : IntegrationTestBase
{
    public UsersParityControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/users/search?q=test";
