...
/*
 * Auth-gate tests for AdminDonationsController.
 * Verifies the [Authorize(Policy = AdminOnly)] gate on /api/admin/donations.
 */
...
public class AdminDonationsControllerAuthTests : IntegrationTestBase
{
    public AdminDonationsControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/admin/donations";
