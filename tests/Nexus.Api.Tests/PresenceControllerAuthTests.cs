...
/*
 * Auth-gate tests for PresenceController.
 * Verifies the class-level [Authorize] gate on /api/presence/online.
 */
...
public class PresenceControllerAuthTests : IntegrationTestBase
{
    public PresenceControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/presence/online";
