...
/*
 * Auth-gate tests for PeerEndorsementsController.
 * Verifies the class-level [Authorize] gate on /api/peer-endorsements (non-anonymous action).
 */
...
public class PeerEndorsementsControllerAuthTests : IntegrationTestBase
{
    public PeerEndorsementsControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/peer-endorsements/user/999999";
