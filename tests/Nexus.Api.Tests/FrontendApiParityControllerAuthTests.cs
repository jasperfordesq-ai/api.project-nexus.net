...
/*
 * Auth-gate tests for FrontendApiParityController.
 * Verifies the class-level [Authorize] gate on FrontendApiParityController via /api/broker/services.
 */
...
public class FrontendApiParityControllerAuthTests : IntegrationTestBase
{
    public FrontendApiParityControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/broker/services";
