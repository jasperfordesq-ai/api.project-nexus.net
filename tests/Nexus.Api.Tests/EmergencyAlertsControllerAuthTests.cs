...
/*
 * Auth-gate tests for EmergencyAlertsController.
 * Verifies the class-level [Authorize] gate on /api/volunteer/emergency-alerts.
 */
...
public class EmergencyAlertsControllerAuthTests : IntegrationTestBase
{
    public EmergencyAlertsControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/volunteer/emergency-alerts";
