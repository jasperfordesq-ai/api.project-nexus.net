...
/*
 * Auth-gate tests for V15SocialCompatibilityController.
 * Verifies the class-level [Authorize] gate on V15SocialCompatibilityController via /api/v2/feed.
 */
...
public class V15SocialCompatibilityControllerAuthTests : IntegrationTestBase
{
    public V15SocialCompatibilityControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/v2/feed";
