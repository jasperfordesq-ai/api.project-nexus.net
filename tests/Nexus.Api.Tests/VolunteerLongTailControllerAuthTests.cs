...
/*
 * Auth-gate tests for VolunteerLongTailController.
 * Verifies the class-level [Authorize] gate on /api/volunteer/expenses/me.
 */
...
public class VolunteerLongTailControllerAuthTests : IntegrationTestBase
{
    public VolunteerLongTailControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/volunteer/expenses/me";
