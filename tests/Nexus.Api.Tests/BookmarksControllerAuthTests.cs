...
/*
 * Auth-gate tests for BookmarksController.
 * Verifies the class-level [Authorize] gate on /api/bookmarks.
 */
...
public class BookmarksControllerAuthTests : IntegrationTestBase
{
    public BookmarksControllerAuthTests(NexusWebApplicationFactory factory) : base(factory) { }

    private const string Path = "/api/bookmarks/collections";
