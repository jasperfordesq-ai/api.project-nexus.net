...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,366 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,221 static matches / 206 missing source operations |
