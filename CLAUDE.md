...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,352 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,207 static matches / 220 missing source operations |
