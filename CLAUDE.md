...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,357 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,212 static matches / 215 missing source operations |
