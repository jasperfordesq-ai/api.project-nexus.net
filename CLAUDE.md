...
| Services | 478 PHP service files | 181 C# service files |
...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,345 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,200 static matches / 227 missing source operations |
