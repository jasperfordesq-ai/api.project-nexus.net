...
| --- | ---: | ---: |
| Controllers | 308 PHP controller files | 211 C# controller files |
| Services | 479 PHP service files | 184 C# service files |
...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,423 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,262 static matches / 167 missing source operations |
