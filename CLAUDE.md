...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,373 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,228 static matches / 201 missing source operations |
