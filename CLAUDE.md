...
| Services | 478 PHP service files | 178 C# service files |
...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,339 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,194 static matches / 233 missing source operations |
