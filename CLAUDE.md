...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,347 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,202 static matches / 225 missing source operations |
