...
| --- | ---: | ---: |
| Controllers | 308 PHP controller files | 209 C# controller files |
| Services | 479 PHP service files | 182 C# service files |
| Models/entities | 200 Laravel model files | 186 EF entity files |
| Migrations | 318 Laravel migrations | 87 EF migration classes excluding designers/snapshot |
...
| Schema tables | 361 Laravel source tables from `scripts/compare-laravel-schema-parity.ps1` | 310 static EF/migration table names; 120 exact matches |
