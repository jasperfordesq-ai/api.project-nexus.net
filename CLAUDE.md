...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,388 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,243 static matches / 186 missing source operations |
