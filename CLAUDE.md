...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,395 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,248 static matches / 181 missing source operations |
