...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,612 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,367 static matches / 62 missing source operations |
