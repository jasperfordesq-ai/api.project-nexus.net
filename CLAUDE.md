...
| --- | ---: | ---: |
| Controllers | 308 PHP controller files | 210 C# controller files |
| Services | 479 PHP service files | 183 C# service files |
...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,405 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,253 static matches / 176 missing source operations |
