...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,383 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,238 static matches / 191 missing source operations |
