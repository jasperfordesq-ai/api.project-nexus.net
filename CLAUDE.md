...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,382 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,237 static matches / 192 missing source operations |
