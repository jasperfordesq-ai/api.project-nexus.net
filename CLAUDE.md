...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,385 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,240 static matches / 189 missing source operations |
