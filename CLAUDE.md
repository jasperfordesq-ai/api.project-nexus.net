...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,384 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,239 static matches / 190 missing source operations |
