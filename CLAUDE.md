...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,371 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,226 static matches / 203 missing source operations |
