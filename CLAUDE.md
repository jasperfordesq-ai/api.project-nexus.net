...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,392 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,246 static matches / 183 missing source operations |
