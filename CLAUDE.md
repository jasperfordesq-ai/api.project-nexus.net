...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,355 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,210 static matches / 217 missing source operations |
