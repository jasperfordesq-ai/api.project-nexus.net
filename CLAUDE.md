...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,359 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,214 static matches / 213 missing source operations |
