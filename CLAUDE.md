...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,379 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,234 static matches / 195 missing source operations |
