...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,358 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,213 static matches / 214 missing source operations |
