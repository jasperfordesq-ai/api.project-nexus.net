...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,619 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,370 static matches / 59 missing source operations |
