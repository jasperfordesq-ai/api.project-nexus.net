...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,354 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,209 static matches / 218 missing source operations |
