...
| --- | ---: | ---: |
| Controllers | 308 PHP controller files | 207 C# controller files |
...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,350 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,205 static matches / 222 missing source operations |
