...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,387 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,242 static matches / 187 missing source operations |
