...
| --- | ---: | ---: |
| Controllers | 308 PHP controller files | 206 C# controller files |
...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,349 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,204 static matches / 223 missing source operations |
