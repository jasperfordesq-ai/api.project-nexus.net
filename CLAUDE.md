...
| API contract | 679 OpenAPI paths / 891 operations | no committed OpenAPI snapshot; 3,342 static operations from `scripts/compare-laravel-api-parity.ps1`; 2,197 static matches / 230 missing source operations |
