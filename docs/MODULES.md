...
| Members and GDPR | `docs/modules/members-and-gdpr.md`, `MemberAvailabilityController.php`, member/GDPR services, Laravel React `AvailabilityGrid.tsx` | user, GDPR, consent, deletion controllers/services; availability-grid `GET/PUT /api/v2/users/me/availability` and `GET /api/v2/users/{id}/availability` contracts are covered by `AvailabilityControllerTests` | Mapped |
