...
| Regional Analytics | `routes/regional-analytics-routes.txt`, `app/Services/RegionalAnalytics*`, regional analytics schema migrations | EF entities/configuration/migration/tests now cover `regional_analytics_subscriptions`, `regional_analytics_reports`, `regional_analytics_access_log`, and `regional_analytics_cache`; API/service/report workflows still need implementation | Partial |
