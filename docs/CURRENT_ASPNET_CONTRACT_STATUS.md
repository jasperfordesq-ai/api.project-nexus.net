...
<!-- doc-consistency: ASPNET_CURRENT_BANKED_SCORE=708/1000 -->
...
The **current banked score is 708/1000 (70.8%)** under Fixed Rubric Baseline 1.
...
| Semantic workflow and canonical-consumer contract parity | 305 | 350 | 45 |
| Schema, migrations, data integrity, and upgrade safety | 129 | 150 | 21 |
| Auth, tenant isolation, security, and localization | 95 | 100 | 5 |
...
`1ff6447012c89744e94d6693463a8032361c5946`, which is also the latest banked
backend implementation, with
Laravel frozen at `903d03d3db78bbf87129ad35728be3b72819acaf` on
2026-07-15 00:52:15 +01:00. Web UK-only commits do not add ASP.NET points and
...
The refund-notification marketplace, secure SSO/OIDC, tenant-bootstrap, and
social-comment mention slices are committed and banked. The corrected tenant-bootstrap set passes 4/4
...
The remaining 292 points are not a single implementation queue. They include
