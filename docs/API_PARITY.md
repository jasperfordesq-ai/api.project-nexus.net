...
| .NET static controller operations | 4,329 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,449 | Static method/path or method/shape matches. |
| Script-generated missing operations | 134 | Live 2026-07-12 regeneration after the group form and image lifecycle; runtime contract verification remains endpoint/workflow-specific. |
...
PostgreSQL applied all 118 migrations through `GroupFormLifecycleParity`.
