...
| .NET static controller operations | 4,452 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,532 | Static method/path or method/shape matches; 60 remain. |
| Script-generated missing operations | 60 | Live 2026-07-13 regeneration after Event Safety parity. Requirements, acknowledgement, guardian-consent, and review route shapes closed; runtime contract verification remains endpoint/workflow-specific. |
