...
| .NET static controller operations | 4,546 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,596 | Static method/path or method/shape matches; 12 remain. |
| Script-generated missing operations | 12 | Live 2026-07-14 regeneration after atomic notification-settings closure. Runtime contract verification remains endpoint/workflow-specific. |

The current expanded remainder contains seven document-era admin vetting writes, two
podcast artwork uploads, two prerender operations, and one group-auto-assignment write.
