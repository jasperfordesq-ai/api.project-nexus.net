...
| .NET static controller operations | 4,504 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,579 | Static method/path or method/shape matches; 29 remain. |
| Script-generated missing operations | 29 | Live 2026-07-13 regeneration after Event Recurrence V2 parity. Recurrence routes are matched; runtime contract verification remains endpoint/workflow-specific. |
