...
| .NET static controller operations | 4,545 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,595 | Static method/path or method/shape matches; 13 remain. |
| Script-generated missing operations | 13 | Live 2026-07-14 regeneration after event-configuration closure. Runtime contract verification remains endpoint/workflow-specific. |

The current expanded remainder contains seven document-era admin vetting writes, two
