...
| .NET static controller operations | 4,410 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,490 | Static method/path or method/shape matches; 102 remain. |
| Script-generated missing operations | 102 | Live 2026-07-12 regeneration after Event People parity. All eight workspace shapes closed; runtime contract verification remains endpoint/workflow-specific. |
