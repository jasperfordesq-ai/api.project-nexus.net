...
| .NET static controller operations | 4,417 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,497 | Static method/path or method/shape matches; 95 remain. |
| Script-generated missing operations | 95 | Live 2026-07-13 regeneration after Event Agenda parity. All seven agenda route shapes closed; runtime contract verification remains endpoint/workflow-specific. |
