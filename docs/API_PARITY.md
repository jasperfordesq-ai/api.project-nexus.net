...
| .NET static controller operations | 4,368 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
| Script-generated source operations | 2,592 | Laravel OpenAPI plus de-duplicated supplemental static API route declarations; Laravel `govuk-alpha*` accessible page routes are excluded. |
| Script-generated matched operations | 2,469 | Static method/path or method/shape matches; 123 remain. |
| Script-generated missing operations | 123 | Live 2026-07-12 regeneration after event-template parity. All nine event-template shapes closed while the Laravel source inventory grew by nine operations; runtime contract verification remains endpoint/workflow-specific. |

The current expanded remainder is dominated by event-product routes. It also
contains seven document-era admin vetting writes and prerender reset/invalidate.
...
PostgreSQL applied all 121 migrations through `EventTemplateWorkflowParity`.
