...
| .NET static controller operations | 4,461 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,541 | Static method/path or method/shape matches; 51 remain. |
| Script-generated missing operations | 51 | Live 2026-07-13 regeneration after Event Ticketing parity. Catalogue, quote, type lifecycle, self/manager allocation, cancellation, and reconciliation route shapes closed; runtime contract verification remains endpoint/workflow-specific. |
