...
| .NET static controller operations | 4,339 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,453 | Static method/path or method/shape matches; 130 remain. |
| Script-generated missing operations | 130 | Live 2026-07-12 regeneration after the group invite/export lifecycle; runtime contract verification remains endpoint/workflow-specific. |
...
PostgreSQL applied all 119 migrations through `GroupInviteAndExportLifecycleParity`.
