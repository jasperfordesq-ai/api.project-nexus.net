...
| .NET static controller operations | 4,325 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,446 | Static method/path or method/shape matches. |
| Script-generated missing operations | 137 | Live 2026-07-12 regeneration after the group Q&A mutation lifecycle; runtime contract verification remains endpoint/workflow-specific. |
