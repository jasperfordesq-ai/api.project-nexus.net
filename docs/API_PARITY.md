...
| .NET static controller operations | 4,441 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,521 | Static method/path or method/shape matches; 71 remain. |
| Script-generated missing operations | 71 | Live 2026-07-13 regeneration after Event Offline Check-in parity. All fourteen workspace/credential/device/manifest/sync/batch/conflict/scan route shapes closed; runtime contract verification remains endpoint/workflow-specific. |
