...
| .NET static controller operations | 4,420 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,500 | Static method/path or method/shape matches; 92 remain. |
| Script-generated missing operations | 92 | Live 2026-07-13 regeneration after Event Staff parity. All three staff route shapes closed; runtime contract verification remains endpoint/workflow-specific. |
