...
| .NET static controller operations | 4,491 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,573 | Static method/path or method/shape matches; 35 remain. |
| Script-generated missing operations | 35 | Live 2026-07-13 regeneration after Event Publication Lifecycle parity. The three publication lifecycle shapes are matched; runtime contract verification remains endpoint/workflow-specific. |
