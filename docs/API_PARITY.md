...
| .NET static controller operations | 4,537 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,589 | Static method/path or method/shape matches; 19 remain. |
| Script-generated missing operations | 19 | Live 2026-07-14 regeneration after marketplace report/appeal closure. Runtime contract verification remains endpoint/workflow-specific. |

The current expanded remainder contains seven document-era admin vetting writes,
two marketplace dispute operations, four event-config operations, two
