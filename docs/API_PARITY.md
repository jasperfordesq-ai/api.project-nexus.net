...
| .NET static controller operations | 4,314 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated missing operations | 11 | Live 2026-07-12 regeneration after the direct-message state slice; runtime contract verification remains endpoint/workflow-specific. |
