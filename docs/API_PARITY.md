...
| .NET static controller operations | 4,319 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,440 | Static method/path or method/shape matches. |
| Script-generated missing operations | 143 | Live 2026-07-12 regeneration after splitting guardian-consent token lookup (GET) from the state-changing grant (POST); runtime contract verification remains endpoint/workflow-specific. |
