...
| Script-generated source operations | 2,583 | Laravel OpenAPI plus de-duplicated supplemental static API route declarations; Laravel `govuk-alpha*` accessible page routes are excluded. |
| Script-generated matched operations | 2,437 | Static method/path or method/shape matches. |
| Script-generated missing operations | 146 | Live 2026-07-12 regeneration after Laravel's expanded supplemental route inventory and the durable-reaction slice; runtime contract verification remains endpoint/workflow-specific. |
...
2026-07-12 live inventory supersedes it with 2,437/2,583 matched and the 146
