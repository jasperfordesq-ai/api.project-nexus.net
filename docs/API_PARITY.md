...
| .NET static controller operations | 4,394 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,482 | Static method/path or method/shape matches; 110 remain. |
| Script-generated missing operations | 110 | Live 2026-07-12 regeneration after canonical registration/waitlist parity. All five lifecycle shapes closed; runtime contract verification remains endpoint/workflow-specific. |
...
PostgreSQL applied all 123 migrations through
`EventRegistrationWaitlistLifecycleParity`.
