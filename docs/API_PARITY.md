...
canonical aliases explicitly. The refreshed live inventory is **2,583/2,608 matched
(25 missing, 99.0%)**. This remains static route
...
| .NET static controller operations | 4,523 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,583 | Static method/path or method/shape matches; 25 remain. |
| Script-generated missing operations | 25 | Live 2026-07-14 regeneration after self-relationship and canonical event alias closure. Runtime contract verification remains endpoint/workflow-specific. |
