...
| .NET static controller operations | 4,529 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,585 | Static method/path or method/shape matches; 23 remain. |
| Script-generated missing operations | 23 | Live 2026-07-14 regeneration after event-federation status closure. Runtime contract verification remains endpoint/workflow-specific. |

The current expanded remainder contains seven document-era admin vetting writes,
six marketplace report/dispute operations, four event-config operations, two
