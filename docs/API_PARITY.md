...
| .NET static controller operations | 4,323 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated missing operations | 13 | The 2026-07-12 fixture passed before the live comparator regenerated the exact Laravel route delta below. Runtime contract verification also remains endpoint/workflow-specific. |

The exact live comparator delta is `GET /api/admin/vetting/policy`,
...
## 2026-07-12 Volunteer Hours Ledger Checkpoint
...
Migration `20260711192124_VolunteerHoursLedgerParity` adds durable log/payment/
...
without fabricated payout/XP evidence. Final non-production certification
applied all 111 migrations to a blank PostgreSQL database, with latest ID
`20260711192124_VolunteerHoursLedgerParity`, and verified the exact
...
migration discovery is green, EF discovers 111 migrations through
`20260711192124_VolunteerHoursLedgerParity`, and the latest model snapshot
builds cleanly.
...
2026-07-12 fixture-backed live inventory supersedes it with 2,436/2,449 matched
and the 13 exact missing routes listed above.
...
111. Its updated contract does not insert legacy money or XP. It links only
...
fabricated evidence. Blank 111/latest replay, valid populated 110-to-111 replay,
