...
| .NET static controller operations | 4,384 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,477 | Static method/path or method/shape matches; 115 remain. |
| Script-generated missing operations | 115 | Live 2026-07-12 regeneration after event-broadcast parity. All eight broadcast shapes closed; runtime contract verification remains endpoint/workflow-specific. |
...
PostgreSQL applied all 122 migrations through `EventBroadcastWorkflowParity`.
