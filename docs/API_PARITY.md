...
| .NET static controller operations | 4,527 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,584 | Static method/path or method/shape matches; 24 remain. |
| Script-generated missing operations | 24 | Live 2026-07-14 regeneration after versioned event-reminder preference closure. Runtime contract verification remains endpoint/workflow-specific. |
