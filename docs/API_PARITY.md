...
| .NET static controller operations | 4,541 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
| Script-generated source operations | 2,608 | Laravel OpenAPI plus de-duplicated supplemental static API route declarations; Laravel `govuk-alpha*` accessible page routes are excluded. |
| Script-generated matched operations | 2,591 | Static method/path or method/shape matches; 17 remain. |
| Script-generated missing operations | 17 | Live 2026-07-14 regeneration after marketplace dispute closure. Runtime contract verification remains endpoint/workflow-specific. |

The current expanded remainder contains seven document-era admin vetting writes,
four event-config operations, two
podcast artwork uploads, two prerender operations, one group-auto-assignment write,
and one notification-settings write.
The document-era vetting routes are
deliberately unresolved until legacy evidence disposition is safe; they must
never authorize contact. Route closure would still not prove
the workflows.
