...
| .NET static controller operations | 4,346 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,460 | Static method/path or method/shape matches; 123 remain. |
| Script-generated missing operations | 123 | Live 2026-07-12 regeneration after the admin event lifecycle; runtime contract verification remains endpoint/workflow-specific. |
...
PostgreSQL applied all 120 migrations through `EventLifecycleParity`.
