...
| .NET static controller operations | 4,321 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,442 | Static method/path or method/shape matches. |
| Script-generated missing operations | 141 | Live 2026-07-12 regeneration after the tenant-scoped authentication-configuration workflow; runtime contract verification remains endpoint/workflow-specific. |
