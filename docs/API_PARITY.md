...
| .NET static controller operations | 4,427 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,507 | Static method/path or method/shape matches; 85 remain. |
| Script-generated missing operations | 85 | Live 2026-07-13 regeneration after Event Calendar parity. All seven calendar/feed-token route shapes closed; runtime contract verification remains endpoint/workflow-specific. |
