...
| .NET static controller operations | 4,318 | Generated by `scripts/compare-laravel-api-parity.ps1`; not a parity score. |
...
| Script-generated matched operations | 2,439 | Static method/path or method/shape matches. |
| Script-generated missing operations | 144 | Live 2026-07-12 regeneration after Laravel's expanded supplemental route inventory and the tenant-aware PWA-manifest slice; runtime contract verification remains endpoint/workflow-specific. |

The current expanded remainder is dominated by event-product routes. It also
contains seven document-era admin vetting writes, prerender reset/invalidate,
and guardian-consent token verification. The document-era vetting routes are
