...
| OpenAPI operations | 891 | 3,619 static controller operations from parity script |
...
operations after supplemental API route parsing and de-duplication, 2,370 static
matches, and 59 missing operations. Laravel `govuk-alpha*` accessible page
...
`artifacts/parity/backlog/parity-backlog.json` on 2026-07-05 with 6,546 open
