...
| OpenAPI operations | 891 | 3,370 static controller operations from parity script |
...
operations after supplemental API route parsing and de-duplication, 2,225 static
