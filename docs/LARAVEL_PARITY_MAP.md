...
| OpenAPI operations | 891 | 3,392 static controller operations from parity script |
...
operations after supplemental API route parsing and de-duplication, 2,246 static
matches, and 183 missing operations. Laravel `govuk-alpha*` accessible page
...
source tables, 312 .NET table names, 122 exact matches, 239 missing Laravel-side
...
`artifacts/parity/backlog/parity-backlog.json` on 2026-07-05 with 6,674 open
