...
| OpenAPI operations | 891 | 3,345 static controller operations from parity script |
...
operations after supplemental API route parsing and de-duplication, 2,200 static
matches, and 227 missing operations. Laravel `govuk-alpha*` accessible page
...
`artifacts/parity/backlog/parity-backlog.json` on 2026-07-04 with 6,722 open
