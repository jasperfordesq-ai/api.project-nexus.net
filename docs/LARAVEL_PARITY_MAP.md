...
| OpenAPI operations | 891 | 3,363 static controller operations from parity script |
...
`artifacts/parity/api/api-parity.json` on 2026-07-05 with 2,427 Laravel source
operations after supplemental API route parsing and de-duplication, 2,218 static
matches, and 209 missing operations. Laravel `govuk-alpha*` accessible page
...
`artifacts/parity/backlog/parity-backlog.json` on 2026-07-05 with 6,705 open
