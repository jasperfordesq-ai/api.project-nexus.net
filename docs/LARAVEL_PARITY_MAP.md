...
| OpenAPI operations | 891 | 3,367 static controller operations from parity script |
...
operations after supplemental API route parsing and de-duplication, 2,222 static
matches, and 205 missing operations. Laravel `govuk-alpha*` accessible page
...
`artifacts/parity/backlog/parity-backlog.json` on 2026-07-05 with 6,699 open
