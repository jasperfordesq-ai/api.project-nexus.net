...
| OpenAPI operations | 891 | 3,358 static controller operations from parity script |
...
operations after supplemental API route parsing and de-duplication, 2,213 static
matches, and 214 missing operations. Laravel `govuk-alpha*` accessible page
...
`artifacts/parity/backlog/parity-backlog.json` on 2026-07-05 with 6,708 open
