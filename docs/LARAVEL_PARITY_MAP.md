...
| OpenAPI operations | 891 | 3,361 static controller operations from parity script |
...
operations after supplemental API route parsing and de-duplication, 2,216 static
matches, and 211 missing operations. Laravel `govuk-alpha*` accessible page
