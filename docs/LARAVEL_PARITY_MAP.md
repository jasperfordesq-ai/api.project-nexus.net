...
4. **Marketplace / commerce / monetization**
   ...
   - Current evidence: Laravel React merchant-onboarding wizard status,
     ...
     `promotion_type` and Laravel-style success/data envelopes. Community
     delivery offer create/list/accept/confirm calls now use React payloads and
     Laravel response field names/statuses. Donation checkout payment-intent and
     receipt calls now return the React-compatible `client_secret`,
