...
4. **Marketplace / commerce / monetization**
   ...
   - Current evidence: Laravel React merchant-onboarding wizard status,
     ...
     and booked-count state. Pickup reservation, buyer my-pickups, and seller
     QR scan calls now return Laravel reservation field names and picked-up
     status transitions. Community delivery offer create/list/accept/confirm
