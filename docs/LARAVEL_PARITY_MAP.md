...
| OpenAPI operations | 891 | 3,362 static controller operations from parity script |
...
operations after supplemental API route parsing and de-duplication, 2,217 static
matches, and 210 missing operations. Laravel `govuk-alpha*` accessible page
