...
| OpenAPI operations | 891 | 3,369 static controller operations from parity script |
...
operations after supplemental API route parsing and de-duplication, 2,224 static
