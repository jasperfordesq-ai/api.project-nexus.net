...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,364 |
...
score. The current static API report found 2,219 matched operations and 208
