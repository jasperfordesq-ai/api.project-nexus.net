...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,370 |
...
score. The current static API report found 2,225 matched operations and 204
