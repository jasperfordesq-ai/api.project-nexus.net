...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,356 |
...
score. The current static API report found 2,211 matched operations and 216
