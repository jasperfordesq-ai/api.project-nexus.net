...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,355 |
...
score. The current static API report found 2,210 matched operations and 217
