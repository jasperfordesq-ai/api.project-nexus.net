...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,525 |
...
score. The current static API report found 2,313 matched operations and 116
