...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,423 |
...
score. The current static API report found 2,262 matched operations and 167
