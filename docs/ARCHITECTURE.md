...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,386 |
...
score. The current static API report found 2,241 matched operations and 188
