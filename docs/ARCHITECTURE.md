...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,394 |
...
score. The current static API report found 2,247 matched operations and 182
