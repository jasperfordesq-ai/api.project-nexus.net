...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,372 |
...
score. The current static API report found 2,227 matched operations and 202
