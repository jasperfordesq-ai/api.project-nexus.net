...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,369 |
...
score. The current static API report found 2,224 matched operations and 205
