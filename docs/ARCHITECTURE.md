...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,379 |
...
score. The current static API report found 2,234 matched operations and 195
