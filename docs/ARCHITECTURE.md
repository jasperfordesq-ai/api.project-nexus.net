...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,359 |
...
score. The current static API report found 2,214 matched operations and 213
