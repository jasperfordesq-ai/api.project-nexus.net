...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,358 |
...
score. The current static API report found 2,213 matched operations and 214
