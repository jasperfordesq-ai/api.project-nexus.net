...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,405 |
...
score. The current static API report found 2,253 matched operations and 176
