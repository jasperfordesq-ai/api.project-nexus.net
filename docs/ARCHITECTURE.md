...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,352 |
...
score. The current static API report found 2,207 matched operations and 220
