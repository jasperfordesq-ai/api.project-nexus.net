...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,360 |
...
score. The current static API report found 2,215 matched operations and 212
