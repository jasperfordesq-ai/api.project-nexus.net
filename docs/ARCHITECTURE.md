...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,363 |
...
score. The current static API report found 2,218 matched operations and 209
