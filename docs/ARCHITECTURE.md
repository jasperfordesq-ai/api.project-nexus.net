...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,377 |
...
score. The current static API report found 2,232 matched operations and 197
