...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,373 |
...
score. The current static API report found 2,228 matched operations and 201
