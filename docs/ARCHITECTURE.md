...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,384 |
...
score. The current static API report found 2,239 matched operations and 190
