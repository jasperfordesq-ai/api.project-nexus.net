...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,368 |
...
score. The current static API report found 2,223 matched operations and 204
