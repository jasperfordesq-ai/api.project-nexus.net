...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,374 |
...
score. The current static API report found 2,229 matched operations and 200
