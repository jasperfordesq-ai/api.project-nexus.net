...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,382 |
...
score. The current static API report found 2,237 matched operations and 192
