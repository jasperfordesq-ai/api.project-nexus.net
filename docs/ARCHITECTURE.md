...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,353 |
...
score. The current static API report found 2,208 matched operations and 219
