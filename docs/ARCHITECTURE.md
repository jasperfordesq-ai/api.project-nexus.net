...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,390 |
...
score. The current static API report found 2,245 matched operations and 184
