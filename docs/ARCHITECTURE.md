...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,376 |
...
score. The current static API report found 2,231 matched operations and 198
