...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,439 |
...
score. The current static API report found 2,270 matched operations and 159
