...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,354 |
...
score. The current static API report found 2,209 matched operations and 218
