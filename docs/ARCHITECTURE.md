...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,395 |
...
score. The current static API report found 2,248 matched operations and 181
