...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,366 |
...
score. The current static API report found 2,221 matched operations and 206
