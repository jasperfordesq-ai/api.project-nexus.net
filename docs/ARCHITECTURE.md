...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,362 |
...
score. The current static API report found 2,217 matched operations and 210
