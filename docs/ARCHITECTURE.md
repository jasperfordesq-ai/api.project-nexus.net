...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,375 |
...
score. The current static API report found 2,230 matched operations and 199
