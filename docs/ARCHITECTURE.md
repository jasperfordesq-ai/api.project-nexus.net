...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,380 |
...
score. The current static API report found 2,235 matched operations and 194
