...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,388 |
...
score. The current static API report found 2,243 matched operations and 186
