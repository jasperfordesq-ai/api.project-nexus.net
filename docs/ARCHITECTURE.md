...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,392 |
...
score. The current static API report found 2,246 matched operations and 183
