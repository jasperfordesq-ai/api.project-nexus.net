...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,357 |
...
score. The current static API report found 2,212 matched operations and 215
