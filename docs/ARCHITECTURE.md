...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,367 |
...
score. The current static API report found 2,222 matched operations and 205
