...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,341 |
...
score. The current static API report found 2,196 matched operations and 231
