...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,371 |
...
score. The current static API report found 2,226 matched operations and 203
