...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,387 |
...
score. The current static API report found 2,242 matched operations and 187
