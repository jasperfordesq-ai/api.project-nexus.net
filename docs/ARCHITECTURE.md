...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,345 |
...
score. The current static API report found 2,200 matched operations and 227
