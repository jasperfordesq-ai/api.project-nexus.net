...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,361 |
...
score. The current static API report found 2,216 matched operations and 211
