...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,383 |
...
score. The current static API report found 2,238 matched operations and 191
