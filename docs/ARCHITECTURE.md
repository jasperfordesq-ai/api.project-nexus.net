...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,378 |
...
score. The current static API report found 2,233 matched operations and 196
