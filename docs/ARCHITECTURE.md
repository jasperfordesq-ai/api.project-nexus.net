...
| Static controller operations from `scripts/compare-laravel-api-parity.ps1` | 3,385 |
...
score. The current static API report found 2,240 matched operations and 189
