...
export const knowledgeBaseApi = {
  articles: (params?: PaginationParams) =>
    apiClient.get<PaginatedResponse<KbArticle>>('/api/knowledge/articles', { params }).then(r => r.data),
  article: (slug: string) =>
    apiClient.get<KbArticle>(`/api/knowledge/articles/${slug}`).then(r => r.data),
  categories: () =>
