...
export function LoginPage() {
  ...
  const isGenericAppDomain = hostname === 'platform.project-nexus.net' || hostname === 'localhost' || hostname === '127.0.0.1';
  ...
  // This is the fallback for platform.project-nexus.net/login with no slug.
  useEffect(() => {
