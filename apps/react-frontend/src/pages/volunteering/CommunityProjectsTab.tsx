  ...
  const load = useCallback(async () => {
    try {
      ...
      if (res.success && res.data) {
        ...
        setError('Unable to load community projects.');
      }
    } catch (err) {
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between flex-wrap gap-2">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-semibold text-theme-primary">Community Projects</h2>
        </div>
        <Button
      ...
      {!error && !isLoading && projects.length === 0 && (
        <EmptyState
          ...
          description="Be the first to propose a volunteer project for the community!"
        />
      )}
                ...
                <div className="flex flex-wrap items-center gap-2 text-xs text-theme-subtle mb-3">
                  ...
                  {project.target_volunteers != null && (
                    <span className="flex items-center gap-1">
                      ...
                      {project.target_volunteers} needed
                    </span>
                  )}
                </div>
      ...
      >
        <ModalContent>
          {(onClose) => (
            <>
              <ModalHeader className="text-theme-primary">Propose a Project</ModalHeader>
