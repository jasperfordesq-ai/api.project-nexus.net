...
describe('BiometricSettings', () => {
  ...
  it('shows "Add another passkey" when credentials exist', async () => {
    mockGetWebAuthnCredentials.mockResolvedValue([
      { id: 1, display_name: 'Windows Hello', is_discoverable: true, transports: 'internal', created_at: '2026-01-01', last_used_at: null },
    ]);
    render(<BiometricSettings />);
    await waitFor(() => {
  ...
  it('shows confirmation modal when "Remove All Passkeys" is clicked', async () => {
    mockGetWebAuthnCredentials.mockResolvedValue([
      { id: 1, display_name: 'Test', is_discoverable: true, transports: 'internal', created_at: '2026-01-01', last_used_at: null },
      { id: 2, display_name: 'Test 2', is_discoverable: false, transports: 'usb', created_at: '2026-01-02', last_used_at: null },
    ]);
    const user = userEvent.setup();
  ...
  it('shows credential device name', async () => {
    mockGetWebAuthnCredentials.mockResolvedValue([
      { id: 1, display_name: 'Device A', is_discoverable: true, transports: 'internal', created_at: '2026-01-01', last_used_at: null },
    ]);
