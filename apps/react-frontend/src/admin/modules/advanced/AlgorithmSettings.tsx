                ...
                <div>
                  ...
                  {(!health.fulltext.listings || !health.fulltext.users || !health.fulltext.feed_activity) && (
                    <p className="text-xs text-warning mt-2">
                      Run <code className="bg-default-100 px-1 rounded">dotnet ef database update</code> to apply pending migrations.
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {health.embeddings.total === 0 && (
                    <p className="text-xs text-foreground-400 mt-2">
                      Run <code className="bg-default-100 px-1 rounded">POST /api/admin/search/reindex</code> to generate embeddings.
                    </p>
                  )}
                </div>
                  ...
                  <>
                    ...
                    <div>
                      ...
                      {!health.search.meilisearch_available && (
                        <p className="text-xs text-foreground-400 mt-2">
                          Run <code className="bg-default-100 px-1 rounded">POST /api/admin/search/reindex</code> after Meilisearch starts.
                        </p>
                      )}
                    </div>
                  </>
