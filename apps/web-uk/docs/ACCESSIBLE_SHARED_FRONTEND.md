...
`/ideation/{id}/manage`, `/ideation/{id}/drafts`, `/ideation/tags`,
`/ideation/campaigns`, `/ideation/campaigns/{id}`, and `/ideation/outcomes`
GET pages are now partial
Laravel-backed candidates for the Blade ideation challenge list, create/edit
challenge forms, manage hub, drafts, detail, tag-browser, campaigns, campaign
...
`/api/v2/ideation-challenges/{id}/ideas/drafts`, `/api/v2/ideation-tags/popular`,
...
prize inset, idea cards, vote forms, the submit-idea form, draft edit/publish
forms, challenge lifecycle controls, campaign-link controls,
...
challenge unlinking. This remains partial: idea detail GET page, admin
