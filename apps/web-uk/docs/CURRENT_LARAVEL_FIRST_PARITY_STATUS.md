...
published parent is repository commit `9e5b13e3`. The Laravel source baseline
...
| Static locale usage | 7,005 references, 5,330 unique keys, 0 unresolved | Current complete-reference audit |
