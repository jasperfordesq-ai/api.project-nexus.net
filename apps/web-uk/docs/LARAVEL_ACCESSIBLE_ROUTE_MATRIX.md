...
| Achievements | `/achievements` | `/achievements` | Local Blade-style profile summary/daily-reward/challenge/badge empty-state candidate; auth enforcement, gamification feature gate, live XP/badge/challenge data, reward claims, and backend runtime are not certified. |
...
| Achievements | `/achievements`, `/achievements/daily-reward`, `/achievements/challenges/{id}/claim` | Local Blade-style summary/daily-reward/challenge/badge candidate for `/achievements` only. Auth enforcement, `gamification` feature gate, live profile/XP/badges/challenges, daily reward persistence, challenge reward persistence, localization, and runtime certification are not complete. |
