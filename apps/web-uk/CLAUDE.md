...
- `/saved` as the Blade-style Saved items type filter, list shape, removal form shape, and empty state;
- `/resources` as the Blade-style Resources full-library link, search form, card-list shape, download link shape, and empty state;
