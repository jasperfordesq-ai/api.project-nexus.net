...
if (!baseURL) throw new Error('WEB_UK_ACCESSIBILITY_BASE_URL is required. Run npm run smoke:laravel:jobs-mutation.');

const artifactRoot = path.join(__dirname, 'artifacts', 'jobs-mutation');

module.exports = defineConfig({
  testDir: './tests/runtime',
  testMatch: 'jobs-mutation.spec.js',
  fullyParallel: false,
