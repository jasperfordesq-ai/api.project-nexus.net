...
import { ArrowLeft, Calendar, MapPin, Users, Clock, Send } from "lucide-react";
...
function NewEventContent() {
  ...
  const defaultStartDate = toLocalDatetimeString(tomorrow);

  // End time 2 hours later
  const endTime = new Date(tomorrow);
  endTime.setHours(12, 0, 0, 0);
  const defaultEndDate = toLocalDatetimeString(endTime);
