...
import { ArrowLeft, Users, Globe, Lock, Send } from "lucide-react";
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-white/50 mt-1">
              Start a new community around a shared interest
            </p>
          </div>
        </div>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Input
              label="Group Name"
              placeholder="e.g., Local Gardeners Club"
              value={formData.name}
              onValueChange={(value) =>
            ...
            <Textarea
              label="Description"
              placeholder="What is this group about? What kind of members are you looking for?"
